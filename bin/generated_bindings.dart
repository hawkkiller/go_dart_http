...
class NativeLibrary {
  ...
  ffi.Pointer<ffi.Char> handleRequest(
  ...
  late final _handleRequestPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(
              ffi.Pointer<ffi.Char>)>>('handleRequest');
  late final _handleRequest = _handleRequestPtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();

  void registerHandler(
    ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>> h,
  ) {
  ...
  late final _registerHandlerPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(
                  ffi.Pointer<
                      ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>)>>(
      'registerHandler');
  late final _registerHandler = _registerHandlerPtr.asFunction<
      void Function(
